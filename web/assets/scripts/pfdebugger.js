...
var PfConsoleDebugger = {
    showProfiler:function(){
        this.id('pfDebuggerConsole').style.display = 'none';
        this.id('pfDebuggerProfiling').style.display = 'block';
    },
    showByTab: function(type){
        this.id('pfDebuggerConsole').style.display = 'block';
        this.id('pfDebuggerProfiling').style.display = 'none';
